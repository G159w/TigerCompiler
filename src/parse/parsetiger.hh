...
#line 39 "parse/parsetiger.yy" // lalr1.cc:377
...
#line 75 "parse/parsetiger.yy" // lalr1.cc:377
...
#line 75 "parse/parsetiger.hh" // lalr1.cc:377
...
namespace parse {
#line 152 "parse/parsetiger.hh" // lalr1.cc:377
  ...
  public:
    ...
    {
      // decs
      char dummy1[sizeof(ast::DecsList*)];
      ...
      // "identifier"
      char dummy4[sizeof(misc::symbol)];
  ...
  basic_symbol (typename Base::kind_type t, const ast::DecsList* v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_DECS (const location_type& l);
    ...
    , location (other.location)
  {
    ...
    {
      case 65: // decs
        value.copy< ast::DecsList* > (other.value);
        break;

      case 56: // exp
        value.copy< ast::Exp* > (other.value);
        break;
      ...
      case 4: // "identifier"
        value.copy< misc::symbol > (other.value);
        break;
    ...
    , location (l)
  {
    ...
    {
      case 65: // decs
        value.copy< ast::DecsList* > (v);
        break;

      case 56: // exp
        value.copy< ast::Exp* > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ast::DecsList* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ast::Exp* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const misc::symbol v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    {
      case 65: // decs
        value.template destroy< ast::DecsList* > ();
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 65: // decs
        value.move< ast::DecsList* > (s.value);
        break;

      case 56: // exp
        value.move< ast::Exp* > (s.value);
        break;
      ...
      case 4: // "identifier"
        value.move< misc::symbol > (s.value);
        break;
  ...
  parser::symbol_type
  parser::make_ID (const misc::symbol& v, const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_CAST (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_PRIMITIVE (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_DECS (const location_type& l)
  {
    return symbol_type (token::TOK_DECS, l);
  }



} // parse
#line 1577 "parse/parsetiger.hh" // lalr1.cc:377


// //                    "%code provides" blocks.
#line 55 "parse/parsetiger.yy" // lalr1.cc:377
...
#line 1589 "parse/parsetiger.hh" // lalr1.cc:377
